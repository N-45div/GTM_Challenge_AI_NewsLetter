...
export async function GET() {
  ...
  try {
    ...
    // console.log("API Campaigns Route: Fetched Mailchimp Campaigns:", data.campaigns?.length, "entries.") // Removed for cleaner logs
    // console.log("API Campaigns Route: First campaign preview_text (if available):", data.campaigns?.[0]?.preview_text) // Removed for cleaner logs
    ...
    // console.log("API Campaigns Route: Unique Campaigns after filtering:", uniqueCampaigns.size, "entries.") // Removed for cleaner logs
